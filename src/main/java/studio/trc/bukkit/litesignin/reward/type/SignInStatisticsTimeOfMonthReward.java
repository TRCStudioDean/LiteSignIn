    ...
    extends SignInRewardColumn
{
    ...
    public SignInRewardModule getModule() {
        return SignInRewardModule.STATISTICS_TIMES_OF_MONTH;
    }
    ...
    public boolean overrideDefaultRewards() {
        ...
        RobustConfiguration config = ConfigurationUtil.getConfig(ConfigurationType.REWARD_SETTINGS);
        if (config.contains("Reward-Settings.Permission-Groups." + group.getGroupName() + ".Statistics-Times-Of-Month." + settings + ".Override-default-rewards")) {
            return config.getBoolean("Reward-Settings.Permission-Groups." + group.getGroupName() + ".Statistics-Times-Of-Month." + settings + ".Override-default-rewards");
        }
        return false;
    }
    ...
    public List<String> getMessages() {
        ...
        RobustConfiguration config = ConfigurationUtil.getConfig(ConfigurationType.REWARD_SETTINGS);
        if (config.contains("Reward-Settings.Permission-Groups." + group.getGroupName() + ".Statistics-Times-Of-Month." + settings + ".Messages")) {
            return config.getStringList("Reward-Settings.Permission-Groups." + group.getGroupName() + ".Statistics-Times-Of-Month." + settings + ".Messages");
        }
    ...
    public List<String> getBroadcastMessages() {
        if (!isAvailable()) return Collections.EMPTY_LIST;
        RobustConfiguration config = ConfigurationUtil.getConfig(ConfigurationType.REWARD_SETTINGS);
        if (config.contains("Reward-Settings.Permission-Groups." + group.getGroupName() + ".Statistics-Times-Of-Month." + settings + ".Broadcast-Messages")) {
            return config.getStringList("Reward-Settings.Permission-Groups." + group.getGroupName() + ".Statistics-Times-Of-Month." + settings + ".Broadcast-Messages");
        }
        return Collections.EMPTY_LIST;
    }
